...
use tcpbridge::transactions::{new_txid, new_tx, new_outpoint};
...
fun test_backed_pool() {
    ...
    // Add a couple to the UnBackedPool and PegIn
    scenario.next_tx(DUMMY_ADDRESS);
    {
    ...
    scenario.next_tx(DUMMY_ADDRESS);
    {
        ...
        // Check backed pool
        assert_eq!(!is_valid_genesis(&backed_pool, genesis), true);
