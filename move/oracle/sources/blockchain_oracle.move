...
const GENESIS_BLOCK: vector<u8> = vector[
    0, 0, 0, 32, 16, 54, 223, 156, 157, 249, 67, 180, 173, 69, 61, 113, 121, 213, 42, 245, 58, 110,
    162, 210, 17, 46, 254, 145, 31, 193, 120, 167, 244, 194, 90, 24, 33, 184, 239, 76, 190, 159, 29,
    14, 63, 132, 32, 222, 144, 71, 78, 124, 221, 49, 22, 0, 144, 19, 216, 10, 59, 4, 165, 244, 192,
    244, 110, 190, 145, 91, 35, 104, 255, 255, 127, 32, 1, 0, 0, 0,
];
const GENESIS_HASH: vector<u8> = vector[
    157, 160, 169, 92, 74, 169, 170, 129, 49, 27, 35, 72, 7, 149, 43, 37, 126, 38, 213, 50, 204, 62,
    23, 156, 227, 164, 81, 53, 9, 155, 50, 110,
];
const GENESIS_HEIGHT: u64 = 815; // TEMPORARY - DEPENDS ON WHERE THE ORACLE STARTS
const GENESIS_CHAIN_WORK: u256 = 0x660; // TEMPORARY - DEPENDS ON WHERE THE ORACLE STARTS
